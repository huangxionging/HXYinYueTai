...
#pragma mark - 初始化方法
- (id)initWithScrollView:(UIScrollView *)scrollView andDelegate:(id)delegate
{
    if (self = [super init]) {
...
- (void)initial
{
    ...
    arrowImage.image = [UIImage imageNamed:(@"refreshArrow")];
...
- (void)setFrame:(CGRect)frame
{
    ...
    _lastUpdateTimeLabel.font = [UIFont systemFontOfSize: 13.0];
    ...
    _activityView.color = [UIColor colorWithRed: 50 / 256.0 green: 232 / 256.0 blue: 150 / 256.0 alpha: 1];
}
